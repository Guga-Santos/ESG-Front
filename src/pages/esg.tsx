...
export default function Esg() {
  ...
  return (
    ...
    className={`${darkmode ? 'dark': ''} w-screen min-h-screen bg-[#d9ed92] absolute flex flex-col`}>
      <Header />
      <div className={`${darkmode ? 'bg-[#d9ed92]' : 'bg-[#00001e]'} w-screen ${isMobileDevice ? 'mt-12' : 'mt-20'} relative`}>
          ...
          <div className={`p-8 ${isMobileDevice ? "px-3" : "px-28"}`}>
            ...
            <ol className="list-decimal pl-6">
              <li className="text-lg mb-2">
                <strong>Ambiental (E - Environmental):</strong> Esta dimensão trata das práticas e impactos ambientais das empresas. Isso inclui a gestão de recursos naturais, emissões de carbono, conservação da biodiversidade e muito mais.
              </li>
