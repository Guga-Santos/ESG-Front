...
export default function Header() {
  ...
  return (
    <header>
      <nav className="bg-grey border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="" className="flex items-center">
            <img className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" src="https://i.ibb.co/b1tbW5R/Captura-de-tela-de-2023-09-14-11-47-44.png"/>
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">ESG-Simplify</span>
          </a>
